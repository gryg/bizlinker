...
import StageValue from '@/components/global/stage-value'
import SubsidiaryCampaignChart from '@/components/global/subsidiary-campaign-chart'
...
const SubsidiaryPageId = async ({ params, searchParams }: Props) => {
  let currency = 'EUR'
  let sessions
  ...
  if (subsidiaryDetails.connectAccountId) {
    const response = await stripe.accounts.retrieve({
      stripeAccount: subsidiaryDetails.connectAccountId,
    })
  ...
  const campaignPerformanceMetrics = campaigns.map((campaign) => ({
    ...campaign,
    totalCampaignVisits: campaign.CampaignPages.reduce(
      ...
      <div className="relative h-full">
          ...
          <div className="absolute -top-10 -left-10 right-0 bottom-0 z-30 flex items-center justify-center backdrop-blur-md bg-background/50">
            <Card>
              <CardHeader>
                ...
                <Link
                  href={`/subsidiary/${subsidiaryDetails.id}/linkedaccounts`}
        ...
        <div className="flex flex-col gap-4 pb-6">
          <div className="flex gap-4 flex-col xl:!flex-row">
            ...
            <StageValue subsidiaryId={params.subsidiaryId} />
          ...
          <div className="flex gap-4 flex-col xl:!flex-row">
            <Card className="relative">
              ...
              <CardContent className=" text-sm text-muted-foreground flex flex-col gap-12 justify-between ">
                <SubsidiaryCampaignChart data={campaignPerformanceMetrics} />
                <div className="lg:w-[175px]">
                  Total page visits across all campaigns. Hover over to get more
                  details on campaign page performance.
                </div>
              </CardContent>
              <Contact2 className="absolute right-4 top-4 text-muted-foreground" />
            </Card>
...
export default SubsidiaryPageId
