...
import { removeLane, logActivityNotification } from '@/lib/queries'
...
// import StageTicket from './stage-ticket'
...
const StageLane: React.FC<PipelaneLaneProps> = ({
  setAllTickets,
  tickets,
  stageId,
  laneDetails,
  ...
  const handleDeleteLane = async () => {
    try {
      const response = await removeLane(laneDetails.id)
