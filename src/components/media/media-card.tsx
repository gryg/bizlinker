...
import { removeMediaFile, logActivityNotification } from '@/lib/queries'
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-left">
            Are you sure you want to delete this file? All subsidiary using this
        ...
        <AlertDialogFooter className="flex items-center">
          ...
          <AlertDialogAction
            ...
            onClick={async () => {
              setLoading(true)
              const response = await removeMediaFile(file.id)
              await logActivityNotification({
                firmId: undefined,
                description: `Deleted a media file | ${response?.name}`,
                subsidiaryId: response.subSidiaryId,
              })
              toast({
                title: 'Deleted File',
